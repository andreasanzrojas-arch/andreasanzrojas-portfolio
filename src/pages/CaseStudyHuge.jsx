  ...
  return (
    <>
      <SEO
        ...
        description="Redesigned the IA of Google for Education's App Hub — turning a catalog of 108 apps into a guided discovery journey for three distinct user types. Led at Huge."
