...
export default function CaseStudyGlobalPayments() {
  return (
    <CaseStudyCSIA
      ...
      myRole="Lead Product Designer (end-to-end). I owned the full UX process — discovery research, Design Thinking workshop facilitation, information architecture, interaction design, and high-fidelity prototype. I collaborated with product, compliance, and engineering teams across the bank to align on business and regulatory constraints before any screen was designed."
