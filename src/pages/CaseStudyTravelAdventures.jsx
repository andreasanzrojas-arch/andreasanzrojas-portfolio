  ...
  return (
    <>
      <SEO
        ...
        description="Led product design of a B2B2C travel platform — from research and IA to a 40+ screen Figma prototype and full component system."
