  ...
  return (
    <>
      <SEO
        ...
        description="Designed the complete mobile banking experience for Banco Nacional — digital credit card issuance, contactless payments, card management, and real-time transactions."
